...
const searchData = [
  {
    ...
    img: false,
    imgComponent: (
      <img src={hoverSearchImg} className={styles.nothingRow} alt="" />
    ),
    introduce: '',
  ...
  },
  {
    name: '啊朋友再见',
    img: true,
    imgComponent: <img src={searchImg1} className={styles.imgRow} alt="" />,
    introduce: '歌曲',
    introduceOrNot: true,
  },
  {
  ...
  },
  {
    name: '啊!海军',
    img: true,
    imgComponent: <img src={searchImg2} className={styles.imgRow} alt="" />,
    introduce: '1969年的电影',
    introduceOrNot: true,
  },
  {
